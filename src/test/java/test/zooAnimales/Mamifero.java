...
public class Mamifero extends Animal {
    ...
    public static zooAnimales.Animal crearCaballo(String nombre, int edad, String genero) {
        Mamifero.caballos++;
        return new Mamifero(nombre, edad, "pradera", genero, true, 4);
    }

    public static zooAnimales.Animal crearLeon(String nombre, int edad, String genero) {
        Mamifero.leones++;
